...
public class ByeRTCPPacketTest 
{
	...
	{
		final byte[] data = { (byte)0x80, (byte)0xCB, 0x00, 0x00 };
	...
	{
		final byte[] data = { (byte)0x81, (byte)0xCB, 0x00, 0x02, 0x00, 0x00, 0x00, 0x14, 0x01, 0x30, 0x00, 0x00 };
	...
	{
		final byte[] data = { (byte)0x9F, (byte)0xCB, 0x00, (byte)0x5F, 
	...
	public void testCanValidatesCorrectlyFromByteArray() throws UnknownHostException
	{
		...
		try
		{
			ByeRTCPPacket.fromByteArray(new byte[] { (byte)0x82, (byte)0xC9, 0x00, 0x01, 
																0x00, 0x00, 0x00, 0x00 } );
			fail("Expected error");
		}
		catch(IllegalArgumentException e)
		...
		try
		{
			ByeRTCPPacket.fromByteArray(new byte[] { (byte)0x80, (byte)0xD9, 0x00, 0x01, 
																0x00, 0x00, 0x00, 0x00 } );
			fail("Expected error");
		}
		catch(IllegalArgumentException e)
		...
		try
		{
			ByeRTCPPacket.fromByteArray(new byte[] { (byte)0x80, (byte)0xC9, 0x00, 0x03, 
																0x00, 0x00, 0x00, 0x00 } );
			fail("Expected error");
		}
		catch(IllegalArgumentException e)
		...
		try
		{
			ByeRTCPPacket.fromByteArray(new byte[] { (byte)0xA0, (byte)0xC9, 0x00, 0x01, 
																0x00, 0x00, 0x00, 0x00 } );
			fail("Expected error");
		}
		catch(IllegalArgumentException e)
		...
		try
		{
			ByeRTCPPacket.fromByteArray(new byte[] { (byte)0x81, (byte)0xC9, 0x00, 0x02, 
																0x00, 0x00, 0x00, 0x00,
																0x04, 0x00, 0x00, 0x00 } );
			fail("Expected error");
		}
		...
		{
			assertEquals(e.getMessage(), "Expected at least 4 bytes, but found 3", "wrong validation message");
		}
