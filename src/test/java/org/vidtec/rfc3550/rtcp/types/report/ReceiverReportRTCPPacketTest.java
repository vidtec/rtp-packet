...
public class ReceiverReportRTCPPacketTest 
{
	...
	{
		final byte[] data = { (byte)0x80, (byte)0xC9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x14 };
	...
	{
		final byte[] data = { (byte)0x9F, (byte)0xC9, 0x00, (byte)0xBB, (byte)0xFF, (byte)0xFF, (byte)0xFF, (byte)0xFF, 
	...
	{
		final byte[] data = { (byte)0x82, (byte)0xC9, 0x00, (byte)0x0D, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x14, 
								    0x04, 0x03, 0x02, 0x01, 0x01, 0x03, 0x02, 0x01, 0x05, 0x04, 0x03, 0x02, 0x06, 0x03, 0x02, 0x01, 0x07, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
								    0x04, 0x03, 0x02, 0x01, 0x01, 0x03, 0x02, 0x01, 0x05, 0x04, 0x03, 0x02, 0x06, 0x03, 0x02, 0x01, 0x07, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00
		};
	...
	public void testCanValidatesCorrectlyFromByteArray() throws UnknownHostException
	{
		...
		try
		{
			ReceiverReportRTCPPacket.fromByteArray(new byte[] { (byte)0x80, (byte)0xC9, 0x00, 0x03, 
																0x00, 0x00, 0x00, 0x00 } );
			fail("Expected error");
		}
		catch(IllegalArgumentException e)
		...
		try
		{
			ReceiverReportRTCPPacket.fromByteArray(new byte[] { (byte)0xA0, (byte)0xC9, 0x00, 0x01, 
																0x00, 0x00, 0x00, 0x00 } );
			fail("Expected error");
		}
		catch(IllegalArgumentException e)
