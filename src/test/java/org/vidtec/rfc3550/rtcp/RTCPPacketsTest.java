...
public class RTCPPacketsTest 
{
	...
	public void testCorrecltValidatesInvalidPacketData()
	{
		...
		{
			// SR/RR not first
			byte[] data = { (byte)0x80, (byte)0xCA, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
					        (byte)0x80, (byte)0xC9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
			RTCPPackets.fromByteArray( data );
			fail("Expected error");
		}
		catch (IllegalArgumentException e)
		...
		try
		{
			// declared data more than data actual - single
			byte[] data = { (byte)0x80, (byte)0xC9, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00 };
			RTCPPackets.fromByteArray( data );
			fail("Expected error");
		}
		catch (IllegalArgumentException e)
		{
			assertEquals(e.getMessage(), "At least one packet has a malformed length, not enough data remaining.");
		}
		
		try
		{
			// declared data more than data actual - compound
			byte[] data = { (byte)0x80, (byte)0xC9, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00,
					        (byte)0x80, (byte)0xC9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
			RTCPPackets.fromByteArray( data );
			fail("Expected error");
		...
		{
			assertEquals(e.getMessage(), "Unknown type - 0");
		}
		
		try
		{
			// Invalid packet type in stream
			byte[] data = { (byte)0x80, (byte)0xC9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
					        (byte)0x80, (byte)0xF9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
			RTCPPackets.fromByteArray( data );
			fail("Expected error");
		}
		catch (IllegalArgumentException e)
		...
		{
			// Invalid packet type in stream
			byte[] data = { (byte)0x80, (byte)0xCB, 0x00, 0x00,
					        (byte)0x80, (byte)0xF9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
			RTCPPackets.fromByteArray( data );
			fail("Expected error");
		}
	...
	public void testCanCreatePacketsContainerFromMultiplePacketsAsByteArray()
	{
		...
		byte[] data2 = { (byte)0x80, (byte)0xC8, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			  	   	    (byte)0x80, (byte)0xCB, 0x00, 0x00 };
		...
		byte[] data3 = { (byte)0x80, (byte)0xC8, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				 (byte)0x80, (byte)0xCC, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x20, 0x20, 0x20, 0x20 };
		...
		byte[] data4 = { (byte)0x80, (byte)0xC8, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				         (byte)0x80, (byte)0xCA, 0x00, 0x00 /*, 0x00, 0x00, 0x00, 0x00 */ };
	...
	public void testCanBuildRTCPPacketsFromDatagramPacketWhereSourceBufferIsOversizedComparedToReadDataCorrectly()
	{
		...
		byte[] mindata = { (byte)0x80, (byte)0xC9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
						   (byte)0x80, (byte)0xC9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
